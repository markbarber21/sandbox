...
var dhtmlwindow={
imagefiles:['/ddcolorpicker/windowfiles/min.gif', '/ddcolorpicker/windowfiles/close.gif', '/ddcolorpicker/windowfiles/restore.gif', '/ddcolorpicker/windowfiles/resize.gif'], //Path to 4 images used by script, in that order
